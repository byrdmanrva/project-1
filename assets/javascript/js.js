...
$(document).ready(function () {
  ...
  $("#food-search-button").on("click", function () {
    ...
    $.ajax({
      ...
      $("#food-photo").prepend("click image turn to video <br>");

      // right side changes:
      $("#right-default").hide();
      $("#food-results").empty();
      $("#food-results").append(searchTerm);
      $("#food-results").append("<h2>Meal: " + response.meals[0].strMeal + "</h2></br>");
      $("#food-results").append("</br> Area: " + response.meals[0].strArea);
      $("#food-results").append("</br> Category: </br> " + response.meals[0].strCategory + "</br>");
  ...
  $("#drink-search-button").on("click", function () {
    ...
    $.ajax({
      ...
      $("#drink-photo").prepend("click image turn to video <br>");

      // left side changes:
      $("#left-default").hide();
      $("#drink-results").empty();
      $("#drink-results").append("<h2>Drink: " + response.drinks[0].strDrink + "</h2></br>");
